...
public class XPL {
	...
	public static Grammar Grammar = new Grammar("Grammar",
			...
			new Rule("PAtom",new Or(new Call("EndOfInput"),new Call("Cut"),new Call("Pred"),new Call("CharCode"),new Call("PDelay"),new Call("LDelay"),new Call("Skipper"),new Call("Parser"),new Call("Not"),new Call("Call"),new Call("ECall"),new Call("Term"),new Call("Range"), new Call("Dot"), new Call("Action"),new Seq(new Term("("),new Bind("a",new Call("PTerm")),new Term(")"),new Action(new Var("a"))))),
			...
			new Rule("Parser",new Seq(new Term("PARSE"),new Term("("),new Bind("t1",new Call("String")),new Term(")"),new Action(new Apply("grammar.Parse",new Var("t1"))))),
